...
const sources1 = [
  ...
  "sounds/epiano/epiano_c5.wav"
]
const sources2 = [
  "sounds/piano/piano_c2.wav",
  "sounds/piano/piano_d2.wav",
  "sounds/piano/piano_ef2.wav",
  "sounds/piano/piano_f2.wav",
  "sounds/piano/piano_g2.wav",
  "sounds/piano/piano_af2.wav",
  "sounds/piano/piano_bf2.wav",
  "sounds/piano/piano_c3.wav",
  "sounds/piano/piano_d3.wav",
  "sounds/piano/piano_ef3.wav",
  "sounds/piano/piano_f3.wav",
  "sounds/piano/piano_g3.wav",
  "sounds/piano/piano_af3.wav",
  "sounds/piano/piano_bf3.wav",
  "sounds/piano/piano_c4.wav"
]
...
class GameView {
  ...
  init() {
    ...
    const matrixClose = document.getElementsByClassName("close")[0];
    matrixBtn.onclick = () => { matrixModal.style.display = "block"; }
    matrixClose.onclick = () => { matrixModal.style.display = "none"; }
    window.onclick = (event) => {
        if (event.target == matrixModal) { matrixModal.style.display = "none"; }
    }
