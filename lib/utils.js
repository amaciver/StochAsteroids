...
const Util = {
  ...
  resolveCollison(obj1, obj2) {
    ...
    if ((x1 < x2 && u1[0] < 0 && u2[0] >= 0) && (Math.abs(y1 - y2) <= Math.abs(r1-r2)) ) {
      console.log("test1");
      obj2.pos[0] += 25;
      return;
    }
    if ((x2 < x1 && u2[0] < 0 && u1[0] >= 0) && (Math.abs(y1 - y2) <= Math.abs(r1-r2)) ) {
      console.log("test2");
      obj1.pos[0] += 25;
      return;
    }
    if ((y1 < y2 && u1[1] < 0 && u2[1] >= 0) && (Math.abs(x1 - x2) <= Math.abs(r1-r2)) ) {
      console.log("test3");
      obj2.pos[1] += 25;
      return;
    }
    if ((y2 < y1 && u2[1] < 0 && u1[1] >= 0) && (Math.abs(x1 - x2) <= Math.abs(r1-r2)) ) {
      console.log("test4");
      obj1.pos[1] += 25;
      return;
    }
    // if ((x1 < x2 && u1[0] < 0 && u2[0] >= 0) && (y1 < y2 && u1[1] < 0 && u2[1] >= 0)) {
    //   // console.log("test");
    //   return;
    // }
    // if ((x1 < x2 && u1[0] < 0 && u2[0] >= 0) && (y1 < y2 && u1[1] < 0 && u2[1] >= 0)) {
    ...
    //   return;
    // }
    // if (y1 < y2 && u1[1] < 0 && u2[1] >= 0) {
    //   console.log("test");
    //   return;
    // }
    // if (y2 < y1 && u2[1] < 0 && u1[1] >= 0) {
    //   console.log("test");
    //   return;
    // }
