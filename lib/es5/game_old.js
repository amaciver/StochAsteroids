...
// GameOld.prototype.everyObj = function() {
//   let result = [];
//   result = result.concat(this.asteroids);
//   return result;
// };

GameOld.prototype.addAsteroids = function () {
  for (let i = 0; i < this.NUM_ASTEROIDS; i++) {
    this.asteroids.push(new Asteroid(this.randomPosition(), this));
  }
};

GameOld.prototype.draw = function(ctx) {
...
GameOld.prototype.wrap = function(pos, vel, rad) {
  // console.log(vel);
  const result = pos;
...
GameOld.prototype.randomPosition = function () {
...
GameOld.prototype.moveObjects = function() {
  this.checkWalls();
  this.asteroids.forEach((obj) => obj.move());
  this.checkCollisons();
};

GameOld.prototype.checkCollisons = function() {
...
GameOld.prototype.checkWalls = function() {
  for (var i = 0; i < this.asteroids.length; i++) {
...
GameOld.prototype.remove = function(obj) {
